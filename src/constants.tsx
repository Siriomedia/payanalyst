...
import { HomeIcon, UploadIcon, ArchiveIcon, AssistantIcon, SettingsIcon, ShiftIcon, LeaveIcon, AdminIcon, SubscriptionIcon, DatabaseIcon } from './components/common/Icons.tsx';
